...
?>><a href="dash.php?q=5">Remove Quiz</a></li>
          ...
          if (@$_GET['q'] == 6)
              echo 'class="active"';
          ?>><a href="dash.php?q=6">View Questions</a></li>
      </ul>
          </div>
  </div>
</nav>
...
if (@$_GET['q'] == 6) {
    $result = mysqli_query($con, "SELECT * FROM questions ORDER BY sn DESC") or die('Error');
    echo '<div class="panel"><table class="table table-striped title1">
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b></b></td><td style="vertical-align:middle"><b>Questions</b></td><td style="vertical-align:middle"><b>Correct Answer</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
    while ($row = mysqli_fetch_array($result)) {
        $question   = $row['qns'];
        $choice = $row['choice'];
        echo '<tr><td style="vertical-align:middle">' . $c++ . '</td><td style="vertical-align:middle">' . isset($id) . '</td><td style="vertical-align:middle">' . $question . '</td><td style="vertical-align:middle">' . $choice . '</td><td style="vertical-align:middle">' . isset($sn) . '</td>
  <td style="vertical-align:middle"><b><a href="update.php?q=rmquiz&eid=' . isset($eid) . '" class="btn" style="margin:0px;background:red;color:white">&nbsp;<span class="title1"><b>Remove</b></span></a></b></td></tr>';
    }
    $c = 0;
    echo '</table></div>';
}
