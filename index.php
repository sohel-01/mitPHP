...
<div class="row">
<div class="col-lg-6">
<span class="logo">Carpediem</span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <h3 align="center">Welcome To Carpediem-Registration Form</h3>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter your name" class="form-control input-md" type="text" value="<?php echo isset($_GET['name']);?>">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter your Roll no (Ex. C0XXXXXX)" class="form-control input-md" type="text" value="<?php
echo isset($_GET['rollno']);
?>">
...
if (isset($_GET['branch']) == "MADT")
    echo "selected";
?>>Mobile Application Design & Development</option>
  <option value="ECE" <?php
if (isset($_GET['branch']) == "CSFM")
    echo "selected";
?>>Cyber Security & Computer Forensics</option>
  <option value="EEE" <?php
if (isset($_GET['branch']) == "CCBT")
    echo "selected";
?>>Cloud Computing for Big Data</option>
  <option value="IT" <?php
if (isset($_GET['branch']) == "IT")
    echo "selected";
?>>Information Technology</option>
  <option value="CHEM" <?php
if (isset($_GET['branch']) == "IPRC")
    echo "selected";
?>>Internet Programming & Database Management</option>
  <option value="CIVIL" <?php
if (isset($_GET['branch']) == "ITIP")
    echo "selected";
?>>Information Technology Infrastructure</option>
  <option value="MECH" <?php
if (isset($_GET['branch']) == "GRDS")
    echo "selected";
...
if (isset($_GET['branch']) == "CSAC")
    echo "selected";
?>>Computer Software & Database Development</option> </select>
...
<span href="#" data-target="#login" style="color:lightyellow">Devloped By Carpediem<br><br></span></div>
<div class="col-md-2 box">
<a href="feedback.php" style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Feedback</a></div>
<div class="col-md-2 box">
<a href="about.php" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">About Carpediem</a></div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span style="color:darkblue;font-size:12px;font-weight: bold">Login to Administrator</span></h4>
      </div>
